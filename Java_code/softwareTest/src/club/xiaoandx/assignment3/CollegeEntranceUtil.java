...
public class CollegeEntranceUtil {
	 ...
	 * 高考报名出身年份最小要求
	 */
	public static final int REQUIRED_MIX_YEAR = 2005; 
	
	/**
	 * 高考报名出身月份最小要求
	 */
	public static final int REQUIRED_MIX_MONTH = 7; 
	
	/**
	 * 高考报名出身年份最大要求
	 */
	public static final int REQUIRED_MAX_YEAR = 1996; 
	
	/**
	 * 高考报名出身月份最大要求
	 */
	public static final int REQUIRED_MAX_MONTH = 6; 
	
	/**
	 * 高考报名年龄最大要求
	 */
	public static final int REQUIRED_MAX_AGE = 25; 
	
	/**
	 * 高考报名年龄最小要求
	 */
	public static final int REQUIRED_MIX_AGE = 16; 
	...
	public static boolean registrationJudgment(String birthTimeString) {
		if (getYearMonth(birthTimeString)) {
	 ...
	 * @since: 1.0.0   
	 */
	public static boolean getYearMonth(String birthTimeString) {
		String strs[] = birthTimeString.trim().split("-");
		int selectYear = Integer.parseInt(strs[0]);
		int selectMonth = Integer.parseInt(strs[1]);
