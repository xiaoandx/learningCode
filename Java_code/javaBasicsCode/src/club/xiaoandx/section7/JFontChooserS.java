...
public class JFontChooserS extends JDialog {
	...
	private JFontChooserS(Frame parent, boolean modal, Font font) {
		super(parent, modal);
		initAll();
	...
	public static Font showDialog(Frame parent, String s, Font font) {
		JFontChooserS fd = new JFontChooserS(parent, true, font);
		if (s != null)
			fd.setTitle(s);
		fd.setVisible(true);
		Font fo = null;
...
//	Sample.setText("The quick brown fox jumped over the lazy dog.");
		Sample.setText(" 供选择的字体来自当前系统安装的所以字体 ");
	}
