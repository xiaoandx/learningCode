...
![](https://i.loli.net/2021/04/12/OMu7HY5hjElwBtK.png)
...
* 栈的入口、出口的都是栈的顶端位置。
  ...
  ![](https://i.loli.net/2021/04/12/RTeJh2wqru7LfOB.png)
...
![image-20210412170140241](https://i.loli.net/2021/04/12/1vlLmsCbk6MZtA9.png)
...
*  查找元素快：通过索引，可以快速访问指定位置的元素
   ...
   ![](https://i.loli.net/2021/04/12/Me5AniZ39cqJdy6.png)

*  增删元素慢
  * **指定索引位置增加元素**：需要创建一个新数组，将指定新元素存储在指定索引位置，再把原数组元素根据索引，复制到新数组对应索引的位置。如下图![](https://i.loli.net/2021/04/12/q6XdSzer2bjtnC5.png)
  * **指定索引位置删除元素：**需要创建一个新数组，把原数组元素根据索引，复制到新数组对应索引的位置，原数组中指定索引位置元素不复制到新数组中。如下图![](https://i.loli.net/2021/04/12/OLJ2Sk1chDCy65i.png)
...
* **链表**:**linked list**,由一系列结点node（链表中每一个元素称为结点）组成，结点可以在运行时i动态生成。每个结点包括两个部分：一个是存储数据元素的数据域，另一个是存储下一个结点地址的指针域。我们常说的链表结构有单向链表与双向链表，那么这里给大家介绍的是**单向链表**。
  ...
  ![](https://i.loli.net/2021/04/12/o6zqkBQNPixmcy5.png)

简单的说，采用该结构的集合，对元素的存取有如下的特点：

* 多个结点之间，通过地址进行连接。例如，多个人手拉手，每个人使用自己的右手拉住下个人的左手，依次类推，这样多个人就连在一起了。

  ![](https://i.loli.net/2021/04/12/TfHV43tYKhUZ7wB.png)
...
* 增删元素快：
  ...
  *  增加元素：只需要修改连接下个元素的地址即可。
    ...
    ![](https://i.loli.net/2021/04/12/OCwx8sZgu2qa1hU.png)

  *  删除元素：只需要修改连接下个元素的地址即可。

    ![image-20210412170222821](https://i.loli.net/2021/04/12/1K7YfkxZDwbaugA.png)
...
![image-20210412170233635](https://i.loli.net/2021/04/12/9XROEGvKzDNjcw8.png)
...
![](https://i.loli.net/2021/04/12/AJ6qU3GfOudPncy.png)
...
简单的来说，哈希表是由数组+链表+红黑树（JDK1.8增加了红黑树部分）实现的，如下图所示。![](https://i.loli.net/2021/04/12/tEFh1TAK9z8y5mo.png)

看到这张图就有人要问了，这个是怎么存储的呢？

为了方便大家的理解我们结合一个存储流程图来说明一下：

![](https://i.loli.net/2021/04/12/Vn8RBZzOoYaEMcr.png)
